...
const Checkout = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-md  mt-5 mb-16">
            <h2 className="text-2xl font-bold mb-6 text-center">Checkout Page</h2>
                            ...
                            {data.map((item) => (
                                <tr key={item.id} className="text-center">
                                    <td className="py-2 border-b">
                                        <div className="w-12 md:w-20 md:h-20 object-cover">
